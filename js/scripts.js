...
function JBCountDown(settings) {
    var glob = settings;
		glob.now = (new Date().getTime()/1000);
		console.log(glob.now);
    ...
    var clock = {
        set: {
            days: function(){
                ...
                ctx.arc(24,44,20, deg(0), deg((360/glob.total)*(glob.total - glob.days)));
                ctx.lineWidth = 8;
                ctx.stroke();
            ...
            hours: function(){
                ...
                ctx.arc(24,44,20, deg(0), deg(15*glob.hours));
                ctx.lineWidth = 8;
                ctx.stroke();
            ...
            minutes : function(){
                ...
                ctx.arc(24,44,20, deg(0), deg(6*glob.minutes));
                ctx.lineWidth = 8;
                ctx.stroke();
            ...
            seconds: function(){
                ...
                ctx.arc(24,44,20, deg(0), deg(6*glob.seconds));
                ctx.lineWidth = 8;
                ctx.stroke();
